    ...
    while True:
        try:
            ...
            if value < valid_range[0] or value > valid_range[1]:
                print(f"Error: Please enter a number between {valid_range[0]} and {valid_range[1]}.")
                continue
...
def tic_tac_toe():
    """
    Fonction principale du jeu tic-tac-toe avec validation complète des entrées.
    Gère tous les cas d'erreur possibles et détecte les matchs nuls.
    """
